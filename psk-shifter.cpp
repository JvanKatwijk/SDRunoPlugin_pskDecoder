...
#include	<math.h>
	...
	pskShifter::pskShifter	(int32_t size) {
int i;
	this	->tableSize	= size;
	phase			= 0;
	...
	pskShifter::~pskShifter	(void) {
	delete[] table;
}

void	pskShifter::do_shift	(std::complex<float>	*buffer,
	                         int32_t	bufLen,
	                         int32_t	freq) {
...
std::complex<float>
	pskShifter::do_shift	(std::complex<float> z, int32_t freq) {
